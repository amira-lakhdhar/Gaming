...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnNavigateP = findViewById(R.id.loginbutton);
        btnNavigateP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Navigate to SecondActivity
                Intent intent = new Intent(MainActivity.this, LoginActivity.class);
        ...
        TextView btnNavigateR = findViewById(R.id.forgetpassword);
        btnNavigateR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Navigate to SecondActivity
